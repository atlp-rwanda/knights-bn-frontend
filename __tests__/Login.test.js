...
describe('=============>LOGIN<=============', () => {
  ...
  it('should print Incorrect email or password. Please try again. if password is not provided', () => {
    const { getByLabelText, getByText } = LoginComponent();
    const email = getByLabelText('email');
    const password = getByLabelText('password');
    const button = getByLabelText('Login');
  ...
  it('should print error if there is empty fields', () => {
    const { getByLabelText, getByText } = LoginComponent();
    const button = getByLabelText('Login');
    userEvent.click(button);
  ...
  it('should print error if password is not provided', () => {
    ...
    console.log('###-----> check passing email <----', email.value);
    console.log('###-----> check passing password <----', password.value);
    userEvent.click(button);
